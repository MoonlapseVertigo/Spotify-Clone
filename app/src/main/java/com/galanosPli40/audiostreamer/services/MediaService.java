package com.galanosPli40.audiostreamer.services;
...
import com.galanosPli40.audiostreamer.notifications.MediaNotificationManager;
import com.galanosPli40.audiostreamer.players.MediaPlayerAdapter;
import com.galanosPli40.audiostreamer.players.PlaybackInfoListener;
...
public class MediaService extends MediaBrowserServiceCompat {
    ...
    public class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            ...
            if(extras.getBoolean(Constants.QUEUE_NEW_PLAYLIST, false)){
                resetPlaylist();
            }
            ...
            int newQueuePosition = extras.getInt(Constants.MEDIA_QUEUE_POSITION, -1);
            if(newQueuePosition == -1){
                mQueueIndex++;
            }
            else{
                mQueueIndex = extras.getInt(Constants.MEDIA_QUEUE_POSITION);
            }
