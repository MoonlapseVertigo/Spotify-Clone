...
import com.galanosPli40.audiostreamer.client.MediaBrowserHelper;
import com.galanosPli40.audiostreamer.client.MediaBrowserHelperCallback;
import com.galanosPli40.audiostreamer.models.Artist;
import com.galanosPli40.audiostreamer.services.MediaService;
import com.galanosPli40.audiostreamer.util.MainActivityFragmentManager;
import com.galanosPli40.audiostreamer.util.MyPreferenceManager;
import com.galanosPli40.audiostreamer.util.Constants;
        ...
        MediaBrowserHelperCallback
{
    ...
    private class SeekBarBroadcastReceiver extends BroadcastReceiver {
        ...
        @Override
        public void onReceive(Context context, Intent intent) {
            long seekProgress = intent.getLongExtra(Constants.SEEK_BAR_PROGRESS, 0);
            long seekMax = intent.getLongExtra(Constants.SEEK_BAR_MAX, 0);
    ...
    public void onMediaSelected(String playlistId, MediaMetadataCompat mediaItem, int queuePosition) {
        if(mediaItem != null){
            ...
            if(playlistId.equals(currentPlaylistId)){
                ...
                bundle.putBoolean(Constants.QUEUE_NEW_PLAYLIST, true); // let the player know this is a new playlist
    ...
    private void loadFragment(androidx.fragment.app.Fragment fragment, boolean lateralMovement){
    ...
    private void showFragment(androidx.fragment.app.Fragment fragment, boolean backswardsMovement){
        ...
        for(androidx.fragment.app.Fragment f: MainActivityFragmentManager.getInstance().getFragments()){
            if(f != null ){
